...
<title>welcome ChristinaViolin</title>
...
<div class="container-fluid">
	...
	<div class="row-fluid">
		<div class="span7">
			<div class="carousel slide" id="carousel-347413">
				
				<div class="carousel-inner">
					<div class="item">
						<img alt="" src="http://www.christinaviolin.com/images//20170404/00bfa6a15bda316e.jpg" />
					</div>
					<div class="item">
						<img alt="" src="images/Christinaviolin2.jpg" />
					</div>
					<div class="item active">
						<img alt="" src="images/Christinaviolin3.jpg" />
						<div class="carousel-caption">
					</div>
				</div> <a class="left carousel-control" href="#carousel-347413" data-slide="prev">‹</a> <a class="right carousel-control" href="#carousel-347413" data-slide="next">›</a>
			</div>
		</div>
	</div>
	<div class="row-fluid">
